...
class SplunkPushDownRuleTest {
  ...
  private static String filterString(String fieldName) throws Throwable {
    ...
    Method m =
        SplunkPushDownRule.class.getDeclaredMethod("getFilter", SqlOperator.class,
            List.class, StringBuilder.class, List.class);
    m.setAccessible(true);
    StringBuilder buf = new StringBuilder();
    final boolean ok;
    try {
      ok =
          (boolean) m.invoke(null, SqlStdOperatorTable.EQUALS, ImmutableList.of(ref, lit),
              buf, ImmutableList.of(fieldName));
